...
const PieChartSavings = ({ data }) => {
  ...
  useEffect(() => {
    ...
    const incomes = data.map(item => item.amount);
    ...
    const ctx = document.getElementById("myPieChartsavings").getContext("2d");
  ...
  return (
    <div>
      ...
      <canvas id="myPieChartsavings" width="400" height="400"></canvas>
    </div>
  );
};
